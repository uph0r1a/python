...
Now, I replaced everything and the password is 123123 and the name of the database is _thirty_days_python_. This is just an example, your password must be stronger than the example password.
